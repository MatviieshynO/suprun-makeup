  ...
  return (
    <div className=" flex-column sm:justify-around sm:p-4 contacts mb-4">
      ...
      <div className="flex justify-center">
        <form
          action=""
          className="pt-2 mt-2 shadow-lg border-t-2 border-pink-700 shadow-black sm:py-4 sm:my-4 md:min-w-[75vw] xl:min-w-[55vw] sm:min-w-[95vw] rounded-lg form-contacts min-w-[95%]"
        >
          ...
          <div className="flex justify-center py-4">
            <button className="p-2 w-[80%] flex sm:min-w-[90%] border border-black sm:p-2 sm:my-2 rounded-lg justify-center uppercase hover:text-pink-700 hover:border-pink-700 ">
              Send
            </button>
          </div>
        </form>
